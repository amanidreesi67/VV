      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
        ...
        <div className="flex flex-col">
            ...
            <div className="flex flex-wrap gap-3">
              {Object.keys(selectedVariant.stock).map((size) => (
                <button
                  ...
                  className={`min-w-[3rem] h-12 flex items-center justify-center border font-medium transition-all duration-200 ${
                    selectedSize === size
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-center flex-1">
                <button className="w-full px-8 py-4 bg-black text-white text-sm font-bold tracking-wide hover:bg-gray-800 transition-colors uppercase">
                  ADD TO BAG
                </button>
          ...
          <div className="border-t border-gray-200">
            ...
            >
              <p>
                Free shipping on orders over ₹999. Easy returns within 7 days of
                delivery.
              </p>
            </AccordionItem>
